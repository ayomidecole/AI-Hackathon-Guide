...
function App() {
    ...
    return (
        <div className="min-h-screen flex max-md:flex-col bg-[var(--bg-base)] text-[var(--text-primary)] font-sans antialiased max-md:overflow-x-hidden">
            ...
            <aside className="fixed left-0 top-0 bottom-0 w-[min(360px,max(260px,30vw))] shrink-0 flex flex-col p-4 md:p-8 z-10 max-md:relative max-md:w-full max-md:bottom-auto max-md:p-3">
                <div
                    className="rounded-3xl backdrop-blur-xl flex-1 flex flex-col min-w-0 p-5 md:p-8 shadow-2xl max-md:flex-initial max-md:min-h-0 max-md:py-4 max-md:px-5 max-md:rounded-2xl border transition-colors"
                    style={{
                ...
                >
                    ...
                    <h1 className="text-xl md:text-3xl font-bold tracking-tight text-[var(--text-primary)] leading-tight min-w-0 break-words">
                        AI Hackathon Guide
                    </h1>
                    <p className="mt-2 md:mt-3 text-sm text-[var(--text-secondary)] leading-relaxed">
                        A curated list of tools and resources to help you build
            ...
            <main
                id="sections"
                className="flex-1 min-w-0 md:pl-[min(360px,max(260px,30vw))] relative z-0 max-md:overflow-x-hidden"
            >
