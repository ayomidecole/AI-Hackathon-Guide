...
function formatSuggestStackMarkdown(stack) {
  ...
  lines.push(
    `- Start with a planning tool: Cursor (local repo & deep code work), Claude Code (browser-based multi-file editing), Codex web (fast experiments without local setup). For you, **${stack.dev_tool}** is a good default choice.`
  );
